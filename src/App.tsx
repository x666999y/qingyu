...
import { UserAgreementModal, hasAgreedToAgreement, setAgreedToAgreement } from './components/UserAgreementModal';
...
function AppContent() {
  ...
  // 用户协议状态
  const [showAgreement, setShowAgreement] = useState<boolean>(!hasAgreedToAgreement());
  ...
  // 用户同意协议
  const handleAgreeAgreement = useCallback(() => {
    setAgreedToAgreement();
  ...
  return (
    ...
    >
      {/* 用户须知协议弹窗 */}
      {showAgreement && (
        <UserAgreementModal onAgree={handleAgreeAgreement} />
      )}
